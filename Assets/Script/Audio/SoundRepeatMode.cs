...
/// <remarks>Shared by <see cref="SoundRepeater"/> at runtime and the Sound Set inspector's auto-play, so auditioning a set uses the same timing the game will.</remarks>
